...
def graph1_time_series(df):
    ...
    try:
        ...
        save_path = os.path.join(output_dir, '1_mtbm_time_series.png')
...
def graph2_deviation_analysis(df):
    ...
    try:
        ...
        output_dir = '../../outputs/graphs'
        os.makedirs(output_dir, exist_ok=True)
        save_path = os.path.join(output_dir, '2_mtbm_deviation_analysis.png')
        plt.savefig(save_path, dpi=300, bbox_inches='tight')
        plt.close()
        print(f"✅ Saved: {save_path}")
        return True
...
def graph3_performance_dashboard(df):
    ...
    try:
        ...
        output_dir = '../../outputs/graphs'
        os.makedirs(output_dir, exist_ok=True)
        save_path = os.path.join(output_dir, '3_mtbm_performance_dashboard.png')
        plt.savefig(save_path, dpi=300, bbox_inches='tight')
        plt.close()
        print(f"✅ Saved: {save_path}")
        return True
...
def graph4_correlation_matrix(df):
    ...
    try:
        ...
        output_dir = '../../outputs/graphs'
        os.makedirs(output_dir, exist_ok=True)
        save_path = os.path.join(output_dir, '4_mtbm_correlation_matrix.png')
        plt.savefig(save_path, dpi=300, bbox_inches='tight')
        plt.close()
        print(f"✅ Saved: {save_path}")
        return True
...
def main():
    ...
    os.makedirs(output_dir, exist_ok=True)
    data_path = os.path.join(output_dir, 'mtbm_data.csv')
    ...
    if success_count == 4:
        ...
        print("   1. ../../outputs/graphs/1_mtbm_time_series.png")
        print("   2. ../../outputs/graphs/2_mtbm_deviation_analysis.png") 
        print("   3. ../../outputs/graphs/3_mtbm_performance_dashboard.png")
        print("   4. ../../outputs/graphs/4_mtbm_correlation_matrix.png")
        print("   5. ../../outputs/reports/mtbm_data.csv")
        
        print("\n💡 TO VIEW THE GRAPHS:")
        print("   - Navigate to outputs/graphs/ folder")
